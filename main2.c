...
void printRecommendations(PRODUCT *products, int numProducts) {
    if (numProducts == 0) {
        printf("\033[1;31mNo Recommended Products To Display.\033[0m\n");
        return;
    }
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 2: // Filter products based on price
                ...
                printf("Enter Lower Price Limit: ");
                scanf("%d", &lowerLimit);
                ...
                if (filteredCount == 0) {
                    ...
                    printf("\033[1;33mFiltered Products In The Price Range ₹%d - ₹%d:\033[0m\n", lowerLimit, upperLimit);
                    ...
                    printf("\n\033[1;33mDo You Want To See Recommendations Based On:\033[0m\n");
                    printf("1. Rating 📊\n");
                    printf("2. Sales 🛒\n");
                    printf("3. Discount 🎉\n");
                    printf("\033[1;31mEnter Your Choice (1-3):\033[0m ");
                    ...
                    switch (recommendChoice) {
                        case 1:
                            ...
                            printf("\033[1;33mTop Recommended Products Based On Rating:\033[0m\n");
                            break;
                        case 2:
                            // Sort by sales (descending)
                            qsort(recommendedProducts, filteredCount, sizeof(PRODUCT), compareBySales);
                            printf("\033[1;33mTop Recommended Products Based On Sales:\033[0m\n");
                            break;
                        case 3:
                            // Sort by discount (descending)
                            qsort(recommendedProducts, filteredCount, sizeof(PRODUCT), compareByDiscount);
                            printf("\033[1;33mTop Recommended Products BBased On Discount:\033[0m\n");
                            break;
                        default:
                ...
                printf("\n\033[1;33mPress 'b' To Go Back:\033[0m ");
                back = getchar();
                while (getchar() != '\n'); // Clear the input buffer
                if (back != 'b') {
            ...
            case 3: // Top trending products based on rating, sales, discount
                printf("\033[2J\033[H"); // Clear the screen
                printf("\033[1;33mSort Products By:\033[0m\n");
                printf("1. Rating 📊\n");
                printf("2. Sales 🛒\n");
                printf("3. Discount 🎉\n");
                printf("\033[1;31mEnter Your Choice (1-3):\033[0m ");
                ...
                printf("\033[1;32mDo You want To Revert Back To The Original Order? (y/n): \033[0m");
                ...
                if (revertChoice == 'y' || revertChoice == 'Y') {
                    ...
                    printf("\033[1;33mReverted Back To Original Order.\033[0m\n");
            ...
            case 5: // Proceed for payment
                ...
                printf("\033[1;33mItems In Your Cart:\033[0m\n");
                printf("------------------------------------------------------------------------------------------------------------\n");
                printf("| Index | Product Name           | Price      |\n");
                printf("------------------------------------------------------------------------------------------------------------\n");
            ...
            printf("Enter 'e' To Edit, 'v' To View, Or 'b' To Go Back: ");
            back = getchar();
            while (getchar() != '\n'); // Clear the input buffer
            if (back == 'e') {
                ...
                if (index < 1 || index > cartSize) {  // Updated to handle valid index range
                    ...
                    printf("\033[1;32mProduct Removed Successfully!\033[0m\n");
